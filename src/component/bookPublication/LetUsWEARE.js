...
const demandingSpecilaist = () => {
    ...
    return (
        <>
            <section className="mr-lg:!py-[80px] mr-xl:!py-[80px]">
                    ...
                    <div className='grid xl:grid-cols-12 mr-lg:grid-cols-12 m-auto gap-5 md:grid-cols-1 sm:grid-cols-1 xs:grid-cols-1'>
                        ...
                        <div className='col-span-7 '>
                            <div className=' xs:py-0'>
                                ...
                                <p className='mr-sm:px-5 mr-xs:px-5 mt-5 mb-5'>Join the ranks of our satisfied authors and let us transform your publishing aspirations into achievements</p>
