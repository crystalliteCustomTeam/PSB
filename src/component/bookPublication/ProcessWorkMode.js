                            ...
                            <div className="box rounded-2xl bg-[#f2f2f2] text-left text-[#1d1d1f] hover:text-white h-[100%] py-10 px-5 border-2 border-solid transition-[.5s] hover:bg-[#1d1d1f] hover:border-white">
                                ...
                                <p className='text-[20px] text-[#242424] font-semibold leading-6 m-0 transition-[.5s all]'>
                                    ...
                                    <span className='block font-normal text-[13px] leading-5 mt-2'>
                                        We uphold the highest standards of professionalism, ensuring that your book is bound with quality. Our commitment to excellence is non-negotiable.
                                    </span>
                                </p>
                            </div>
                        </div>
                        <div className="col-md hover:-translate-y-1 hover:scale-105 duration-300 h-[250px]">
                            <div className="box rounded-2xl bg-[#f2f2f2] text-left text-[#1d1d1f] hover:text-white h-[100%] py-10 px-5 border-2 border-solid transition-[.5s] hover:bg-[#1d1d1f] hover:border-white">
                                ...
                                <p className='text-[20px] text-[#242424] font-semibold leading-6 m-0 transition-[.5s all]'>
                                    ...
                                    Experience
                                    <span className='block font-normal text-[13px] leading-5 mt-2'>
                                        With years of experience in the publishing industry, we possess a profound understanding of what it takes to make a book successful. We’ve worked with authors from diverse genres, and our portfolio speaks for itself.</span>
                                </p>
                            </div>
                        </div>
                        <div className="col-md hover:-translate-y-1 hover:scale-105 duration-300 h-[250px]">
                            <div className="box rounded-2xl bg-[#f2f2f2] text-left text-[#1d1d1f] hover:text-white h-[100%] py-10 px-5 border-2 border-solid transition-[.5s] hover:bg-[#1d1d1f] hover:border-white">
                                ...
                                <p className='text-[20px] text-[#242424] font-semibold leading-6 m-0 transition-[.5s all]'>
                                    Customization
                                    <span className='block font-normal text-[13px] leading-5 mt-2'>
                                        We understand that every author and book is unique. That’s why our services are fully customizable and tailored to your specific needs and goals. Your vision is at the forefront of everything we do, from book writing to book design services.</span>
                                </p>
                            </div>
                        </div>
                        <div className="col-md hover:-translate-y-1 hover:scale-105 duration-300 h-[250px]">
                            <div className="box rounded-2xl bg-[#f2f2f2] text-left text-[#1d1d1f] hover:text-white h-[100%] py-10 px-5 border-2 border-solid transition-[.5s] hover:bg-[#1d1d1f] hover:border-white">
                                ...
                                <p className='text-[20px] text-[#242424] font-semibold leading-6 m-0 transition-[.5s all]'>
                                    ...
                                    Affordability
                                    <span className='block font-normal text-[13px] leading-5 mt-2'>
                                        We believe that publishing should be accessible to all. Our book services pricing is competitive, and we offer flexible payment options to accommodate your budget.
                                    </span>
                                </p>
                            </div>
                        </div>
                        <div className="col-md hover:-translate-y-1 hover:scale-105 duration-300 h-[250px]">
                            <div className="box rounded-2xl bg-[#f2f2f2] text-left text-[#1d1d1f] hover:text-white h-[100%] py-10 px-5 border-2 border-solid transition-[.5s] hover:bg-[#1d1d1f] hover:border-white">
                                ...
                                <p className='text-[20px] text-[#242424] font-semibold leading-6 m-0 transition-[.5s all]'>
                                    ...
                                    Confidentiality
                                    <span className='block font-normal text-[13px] leading-5 mt-2'>
                                        We take your privacy seriously and maintain strict confidentiality throughout the entire process. Your work is safe in our hands.
                                    </span>
                                </p>
                            </div>
                        </div>
                        <div className="col-md hover:-translate-y-1 hover:scale-105 duration-300 h-[250px]">
                            <div className="box rounded-2xl bg-[#f2f2f2] text-left text-[#1d1d1f] hover:text-white h-[100%] py-10 px-5 border-2 border-solid transition-[.5s] hover:bg-[#1d1d1f] hover:border-white">
                                ...
                                <p className='text-[20px] text-[#242424] font-semibold leading-6 m-0 transition-[.5s all]'>
                                    ...
                                    <span className='block font-normal text-[13px] leading-5 mt-2'>
                                        This is the final stage of the process, ensuring that all tasks are completed and your design is perfected. Our team affirms your success.
                                    </span>
                                </p>
                            </div>
                        </div>
