  ...
  return isPopup ? (
    ...
    <div
      dangerouslySetInnerHTML={{
        __html: `<a href="${link}"  class="flex w-max rounded-[10px_10px_10px_0] transition-all ease-in-out duration-500 justify-center items-center gap-x-2 __animatedPing hover:opacity-90 ${buttonClasses} ${css}" ${
