            ...
            <section className="mr-lg:!py-[100px] mr-md:!py-[80px] py-[60px] relative">
                <div className="mr-container relative z-10 font-secondary">
                    <div className="text-center justify-content-center ">
                        <h6 className='mr-md:text-3xl text-2xl text-[#40BEE2] font-semibold'>Let Us Help You</h6>
                        <h2 className='mr-lg:text-[50px] mr-md:text-[40px] text-3xl leading-tight py-2 font-semibold xs:text-4xl'>What Sets Us Apart?</h2>
