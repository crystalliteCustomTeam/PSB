    ...
    return (
        <>
            ...
            <div className="copyright bg-[#40BEE2] py-2">
                <p className='text-[14px] text-white text-center'>© 2024 - All Rights Reserved <Link href={"https://infinitimediainc.com/"} className='hover:text-black'>Infiniti Media INC</Link></p>
            </div>
        </>
    )
}
