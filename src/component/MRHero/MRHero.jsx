        ...
        <section>
            <div className={`relative pt-[80px] ${fullImg} bg-no-repeat ${classes} !border-b-[#00c4e4] border-solid border-b-[1px]`}>
                <div className="mr-container">
                    <div className="grid grid-cols-1 mr-md:grid-cols-12 items-center ${beforeImg} gap-y-5 mr-md:gap-y-0 mr-md:gap-x-4 ">
                        ...
                        {form && <div className={`z-10 mr-md:col-span-5 mr-xs:mt-5 mr-sm:mt-5 mr-lg:col-span-6 bg-no-repeat ${beforeImg} before:bg-no-repeat before:absolute before:bg-cover before:w-[43%] mr-lg:before:w-[45%] mr-xl:before:w-[48%] before:h-full -z-10 before:right-0 before:bottom-0 before:top-0 before:opacity-25`}>
                            <MRHeroForm />
                        </div>}
                    </div>
                </div>
