...
const Header = () => {
  ...
  return (
    <>
      {/* <TOPHEADER1 /> */}
      <div
        className={`font-secondary px-0 sm:!px-2 xs:!px-2 pt-0 transition-all duration-1000 ease-in-out ${
        ...
        <header className="bg-white relative z-30 py-5">
          <div className="mr-container">
            <div className="items-center justify-between gap-x-4 flex grid-cols-2 grid-rows-1">
              ...
              <nav className="flex gap-10 text-[16px] text-[#1d1d1f] font-medium">
                <ul
                  id="menu"
                  className={`${
                    menuOpen
                      ? "transform translate-x-0 mr-2xl:!flex mr-xl:!flex mr-lg:!flex md:hidden xs:hidden sm:hidden"
                ...
                >
                  <li className="xl:hidden lg:hidden mr-2xl:!hidden mr-xl:!hidden mr-lg:!hidden block sm:z-90 xs:z-90 fixed top-2 right-6">
                    <Link
                  ...
                  {[
                    ...
                    <li>
                      <Link
                        href={url}
                        className={`list mr-2xl:!text-black mr-xl:!text-black  mr-lg:!text-black md:!text-white sm:!text-white text-black xs:!text-white text-[18px] font-[400]`}
                      >
                        {title}
                      </Link>
                    </li>
                ...
                >
                  <Image
                    ...
                    height={15}
                    alt="Amazon Book Publishing"
                    className="transition-all ease-in-out duration-300 group-hover:brightness-100 group-hover:invert"
                    priority={true}
                  />
              ...
              <div className="flex items-center mr-2xl:hidden mr-xl:hidden mr-lg:hidden md:block xs:block sm:block z:-1">
                <button
