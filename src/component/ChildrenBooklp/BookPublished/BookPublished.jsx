                        ...
                        <div className='mr-3xl:w-11/12'>
                            ...
                            <div className="bg-[#40BEE2] rounded-[15px] flex flex-col gap-6 py-4 mr-xl:py-8 px-6">
                                <Link href="mailto:info@bestsellingpublisher.com" className='flex items-center gap-x-3'>
                                    ...
                                    <span className='text-[15px] mr-md:text-[18px] leading-[24px] text-white font-normal'>info@bestsellingpublisher.com</span>
                                </Link>
                                <Link href="tel:(800) 781-9093" className='flex items-center gap-x-3'>
                                    <Image src={Phone} alt='BSP' className='w-[20px] h-[20px] mr-md:w-auto mr-md:h-auto' />
                                    <span className='text-[15px] mr-md:text-[18px] leading-[24px] text-white font-normal'>(800) 781-9093 (Toll Free)</span>
                                </Link>
                                <Link href="#" className='flex items-center gap-x-3'>
                                    <Image src={Location} alt='BSP' className='w-[20px] h-[20px] mr-md:w-auto mr-md:h-auto' />
                                    <span className='text-[15px] mr-md:text-[18px] leading-[24px] text-white font-normal'>445 S.Figueroa Street, Los Angeles, CA 90071 </span>
                                </Link>
                            </div>
                        </div>
                    </div>
