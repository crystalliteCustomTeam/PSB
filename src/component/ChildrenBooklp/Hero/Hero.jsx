            ...
            <div className="relative z-10 pt-[95px] mr-sm:pt-[135px] mr-lg:pt-[100px] mr-2xl:pt-[130px] pb-[50px]">
                ...
                <div className="mr-container">
                    <div className="mr-sm:text-center text-white mr-2xl:w-[70%] mr-lg:w-[75%] w-full mx-auto ">
                        ...
                        <p className="mr-2xl:text-[16px] text-sm font-normal leading-normal text-justify">Unlock the potential of your children's story with our expert publishing services, designed to captivate young readers and create lasting memories. From vibrant illustrations to seamless distribution, we turn your manuscript into a cherished classic that stands the test of time.</p>
