            ...
            <div>
              <div className="mr-lg:block hidden">
                <Image
                  src={CTAImg}
                  alt="Best Selling Publisher"
                  className="absolute rounded-[20px] mr-2xl:h-[650px] mr-xl:h-[600px] h-[550px] w-auto mr-2xl:top-[-15%] mr-xl:top-[-10%] right-0 mr-2xl:left-[-2%] mr-xl:left-[-5%] left-[-10%] bottom-0"
                />
              </div>
              ...
              <div className="p-3 mr-lg:w-[50%] w-full mr-lg:ml-auto">
                ...
                <div className="mx-auto">
                  <form className="" autoComplete="off">
                    <div className="grid mr-md:grid-cols-2 grid-cols-1 mr-xl:gap-3 gap-3 mb-5 items-center">
                      <div>
                        <input
                          type="text"
                          required
                    ...
                    <div className="flex items-center justify-center">
                      <button type="submit" className="w-full block h-[50px] text-center text-[16px] text-white bg-black font-semibold px-10 rounded-lg">
