                    ...
                    <div className={`${img1 ? "flex gap-3 mr-lg:gap-5 items-center !flex-wrap mr-lg:!flex-nowrap" : ""} ${direction}`}>
                        <div className={`${img1 ? "basis-full mr-lg:basis-1/2" : ""}`}>
                            <div className={`${img2 ? "grid grid-cols-1 mr-lg:grid-cols-2 gap-5 items-center" : ""}`}>
                                ...
                                <div>
                                    {img2 && <Image src={img2} alt="img" width={900} height={100} className="!w-auto mx-auto" loading="lazy" priority/>}
                                </div>
                            </div>
                        </div>
                        {img2 && (
                        ...
                        <div className={`${img1 ? "basis-full mr-lg:basis-1/2" : ""}`}>
                            {img1 && <Image src={img1} alt="img" width={900} height={100} className="!w-auto mx-auto" loading="lazy" priority/>}
                        </div>
                    </div>
                </div>
            </div>
