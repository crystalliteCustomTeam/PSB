...
const Header = () => {
  return (
    <header>
      <div className="mr-sm:block hidden py-5 bg-[#8f181b]">
        <div className="mr-container">
          <div className="flex items-center justify-between">
            ...
            >
              <Image src={Mail} alt="icon" width={25} height={25} />
              <span className="text-[17px] leading-tight font-normal text-white">
