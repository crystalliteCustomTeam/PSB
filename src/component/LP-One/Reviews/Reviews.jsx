            ...
            <div className="mr-container">
                <div>
                    <div className="text-center">
                        <h2 className="mr-xl:text-[45px] mr-lg:text-[40px] mr-md:text-[30px] text-[25px] leading-tight font-bold mb-5 font-primary">
                        ...
                        Review.map((testimonial, i) => (
                            <swiper-slide key={i}>
                                <div className="shadow-md">
                                    <div className="mr-lg:my-[50px] mr-md:my-[40px] mr-md:py-[50px] py-[30px] bg-[#fff] w-full h-full">
                                        <Image quality={95}
                                        ...
                                        <div className="text-center">
                                            ...
                                            <h4 className="text-2xl font-bold text-[#40BEE2]">{testimonial.name}</h4>
                                        </div>
                                    </div>
                                </div>
                            </swiper-slide>
