...
const Contact = () => {
    ...
    return (
        <section className="relative z-10">
            <div className="py-[30px] mr-lg:py-[50px] before:bg-no-repeat before:absolute before:left-0 before:right-0 before:top-0 before:bottom-0 before:-z-10 before:bg-cover before:h-[70%] before:bg-center before:bg-[url('../../public/ahsan/students-working-study-group.png')]">
