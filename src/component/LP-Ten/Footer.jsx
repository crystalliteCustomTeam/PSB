...
export default function Footer() {
  return (
    <footer>
      <div className="bg-[#11294f] py-[40px] text-white text-[15px]">
      ...
      <div className="bg-[#0c1f3c] text-[15px] py-[20px]">
        <div className="mr-container">
          <div className="relative z-10">
            <a href="#" className="absolute right-0 top-[-40px]">
              <Image src={TopIcon} alt="top_icon" />
            </a>
            <span className="block mr-md:text-start text-center text-base leading-tight font-normal text-white">
