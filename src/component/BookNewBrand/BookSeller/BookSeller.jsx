                        ...
                        <div className="col-span-12 mr-lg:col-span-6">
                            ...
                            <div>
                                <div className="flex flex-col mr-xl:flex-row mr-xl:items-center mr-xl:gap-x-12 gap-y-5 pb-3 mr-lg:pb-4">
                                    <Link href="mailto:info@bestsellingpublisher.com" className='flex items-center gap-2 text-[14px] mr-md:text-[15px] poppins font-[500] break-all'>
...
=======
                                    445 S.Figueroa Street, Los Angeles, CA 90071 
>>>>>>> 0263f622c538ec463f70a0ddf496f3ff40b5a897
                                </Link>
                            </div>
                        </div>
                        <div className="col-span-12 mr-lg:col-span-6">
