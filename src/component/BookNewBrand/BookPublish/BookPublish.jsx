                        ...
                        <div className="col-span-12 mr-xl:col-span-7">
                            <div className="txt px-[20px] mr-md:px-[50px] py-[40px] mr-md:py-[60px] text-center mr-md:text-left">
                                ...
                                <div className="flex flex-col mr-md:flex-row items-center gap-4 mt-8">
                                    <Link href="mailto:info@bestsellingpublisher.com" className='bg-white hover:bg-black hover:duration-700 ease-in-out duration-700 rounded-full shadow-[0_10px_20px_0px_#0000001A] w-full mr-md:w-max h-[42px] px-4 mr-lg:px-6 flex items-center justify-center text-black hover:text-white poppins uppercase text-[15px] font-[500]'>
