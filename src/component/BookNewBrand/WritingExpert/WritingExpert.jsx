                ...
                <div className="grid grid-cols-12 items-center gap-y-10">
                    <div className="col-span-12 mr-lg:col-span-6">
                        ...
                        <div className="flex flex-col mr-md:flex-row items-center gap-4 mt-9">
                            <Link href="mailto:info@bestsellingpublisher.com" className='bg-[#65c7e4] hover:bg-black hover:duration-700 ease-in-out duration-700 rounded-full shadow-[0_10px_20px_0px_#0000001A] w-full mr-md:w-max h-[42px] px-4 mr-lg:px-6 flex items-center justify-center text-white poppins uppercase text-[15px] font-[400]'>
