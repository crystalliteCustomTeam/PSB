                    ...
                    <div className="grid grid-cols-12 mr-lg:gap-x-5 gap-5 items-center">
                        <div className="mr-xl:col-span-5 mr-lg:col-span-6 col-span-12 relative z-10">
                            <div className="mr-lg:mb-0 mb-5 text-black">
                                ...
                                <MRCTA text="Get Free Consultation"  classes="bg-primary-100 !rounded-full mr-md:my-8 my-5 mr-md:text-base text-sm hover:bg-black hover:border-black" link="javascript:void(Tawk_API.toggle())" animation="__animatedPing" />
