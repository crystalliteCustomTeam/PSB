            ...
            <div className='items-center relative mr-xl:py-[150px] mr-lg:py-[150px]'>
              ...
              <div className='mx-auto py-4'>
                <div className='flex gap-3 mr-xl:!justify-start md:!justify-center sm:!justify-center xs:!justify-center'>
                  <a href='tel:800-781-9093' className='bg-black text-white hover:bg-white hover:border-solid hover:border-[1px] hover:text-[#1d1d1f] hover:transition-all hover:transform-gpu flex items-center justify-center py-2 px-10'>Get Started</a>
                  <a onClick={openLiveChat} href='#' className='bg-transparent text-white border-solid border-[#1d1d1f] border-[2px] hover:bg-white hover:text-[#000] hover:border-[2px] hover:border-white flex items-center justify-center py-2 px-10'>Live Chat</a>
                </div>
              </div>
            </div>
