                    ...
                    <div className="py-[20px]">
                        <div className="grid grid-cols-12 mr-lg:gap-0 gap-5 items-center">
                            <div className="mr-2xl:col-span-6 text-white mr-lg:col-span-7 col-span-12 mr-sm:text-start text-justify">
                                ...
                                <MRCTA text="Get Free Consultation" classes="__animatedPing bg-black text-white mt-6 hover:bg-transparent hover:border-black hover:text-secondary-100" link="javascript:void(Tawk_API.toggle())" />
                            </div>
