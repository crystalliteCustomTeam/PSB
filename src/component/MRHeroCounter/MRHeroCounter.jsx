                ...
                counterArr?.map(([icon, num, text]) => (
                    <div key={num} className="flex items-center gap-2 mr-xl:gap-3">
                        ...
                        <div className="text-center">
                            ...
                            <span className="hidden mr-lg:inline-block text-[12px] mr-xl:text-[16px] mr-2xl:text-[18px] font-sans font-semibold text-primary-100 leading-normal uppercase">{text}</span>
                        </div>
                    </div>
                ))
            }
