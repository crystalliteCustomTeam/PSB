...
const ProfessionalGhostwriting = () => {
  ...
  const MRCardData = [
    {
      classes:
        "bg-[#F2F2F2] shadow-lg px-3 rounded-lg relative py-[40px] mr-lg:mt-[30px] mr-md:mt-[20px] mt-[16px]  transition-all duration-300 ease-in-out group hover:!bg-[#000] hover:!text-white text-center",
      content: [
        {
          icon: "",
  ...
  return (
    <main>
      <Head>
        ...
        <title>
          Professional Ghostwriting Services | Best Selling Publisher
        </title>
        <meta
          name="description"
          content="Best Selling Publisher offers professional ghostwriting services tailored to your needs. Start your publishing journey today and see why we're the premier choice for authors."
        />
