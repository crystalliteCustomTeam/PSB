  ...
  return (
    <>
      ...
      <main className={`${primary.className} ${SfProDisplay.variable}`}>
        {router.pathname == "/lp-one" || router.pathname == "/book-marketing-company" || router.pathname == "/lp-four" || router.pathname == "/case-studies" ? "" : <Headernew />}
        {/* {loadScript ? <Component {...pageProps} /> : <Loader />} */}
        <Component {...pageProps} />
        {router.pathname == "/book-marketing-company" || router.pathname == "/lp-four" ? "" : <Footer1 />}
      </main>
      {loadScript && (
        <>
          <Script>
