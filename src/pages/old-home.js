    ...
    <>
      <div className='mx-auto font-secondary'>
        ...
        <BW1
          ...
          descs={'To give our customers a high-end result, we have hired professional experts with years of experience that are the most demanded. Therefore, don’t worry while choosing Barnett Ghostwriting for your service because working with us means getting the best.'}
        />
        <CTA3 />
        <BTM />
        <WMODE1 />
