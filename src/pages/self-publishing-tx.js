...
const SelfPublishingFa = () => {
  return (
    <main>
      <Head>
        <title>Self Publishing in Texas - Best Selling Publisher</title>
        <meta
          name="description"
          content="As the best self publishing company in Texas we vow to make your book the next best seller on all major publishing platforms. Hire us today! 
"
        />
        <link
          rel="stylesheet"
...
export default SelfPublishingFa;
