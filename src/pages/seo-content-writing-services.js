...
const MRCardData = [
  {
    classes:
      "bg-[#F2F2F2] shadow-lg px-3 rounded-lg relative py-[40px] mr-lg:mt-[30px] mr-md:mt-[20px] mt-[16px]  transition-all duration-300 ease-in-out group hover:!bg-[#40BEE2] hover:!text-white text-center",
    content: [
      {
        icon: Research,
  ...
  return (
    <main>
      <Head>
        ...
        <meta
          name="description"
          content="Best Selling Publisher offers SEO content writing services tailored to your needs. Start optimizing your website’s SEO by hiring our SEO content writers."
        />
