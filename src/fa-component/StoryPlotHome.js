    ...
    return (
        <>
            <section className='relative bg-white mr-lg:h-[600px] mr-lg:mb-[80px] '>
                <div className="before:bg-[url('../../public/ahsan/students-working-study-group.png')] before:bg-no-repeat before:bg-cover before:mr-lg:h-[520px] before:z-auto before:mr-lg:block before:mr-xl:block before:sm:hidden before:xs:hidden before:backdrop-blur-md">
                        ...
                        <div className="storyplot grid mr-lg:grid-cols-2 mr-2xl:mt-[-400px] mr-lg:mt-[-430px]">
                            <div className='border-b-[1px] border-solid border-[#707070] mr-lg:pb-5 border-[80%]'>
                                <div className="md:text-left sm:text-left xs:text-left z-10">
                                    ...
                                    <h2 className='mr-xl:text-[45px] mr-lg:text-[35px] font-bold font-primary text-secondary leading-normal mr-lg:!text-white mb-2 text-black'>First-Class Book Publishers </h2>
                                ...
                                <div className='flex mr-lg:mt-10 mr-xl:mt-10 mr-md:gap-5 mr-xs:gap-2 items-center w-[80%] md:m-auto md:w-[70%] sm:w-[100%] xs:w-[100%] mr-xs:mt-3'>
                                    <Image
                                        src={image1}
                                        qualit={95}
                                        width={100}
